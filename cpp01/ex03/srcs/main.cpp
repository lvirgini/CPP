...
/*
** If object can be NULL or inexisting (like weapons here) it's appropriate to
**	use pointer.
**
** If object can't be NULL and must always exist (like name here) it's appropriate to
** use reference.
*/
