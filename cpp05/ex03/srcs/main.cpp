...
/*   Updated: 2021/12/25 16:13:25 by lvirgini         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* -------------------------------------------------------------------------- */
	...
	Form *shrub = new ShrubberyCreationForm(blue.getName());
...
/* -------------------------------------------------------------------------- */
	...
	Form *president = new PresidentialPardonForm(blue.getName());
...
/* -------------------------------------------------------------------------- */
	...
	Form	*robot = new RobotomyRequestForm(boss.getName());
